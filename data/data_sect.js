...
export const DATA_SECT = {
    ...
    TRAITS: {
        ...
        // ==========================================
        '尋脈點穴': { desc: '天生對礦脈敏感，未來靈礦脈產能 x1.8', effect: { mine_mult: 1.8 }, type: 'buff' },
        '黃金礦工': { desc: '挖礦是一門藝術，未來靈礦脈產能 x1.5', effect: { mine_mult: 1.5 }, type: 'buff' },
        '天生鼎爐': { desc: '控火奇才，未來煉丹房產能 x2.0', effect: { alchemy_mult: 2.0 }, type: 'buff' },
        '巧奪天工': { desc: '打鐵奇才，未來煉器室產能 x2.0', effect: { forge_mult: 2.0 }, type: 'buff' },
        '悟性驚人': { desc: '任何功法一學就會，獲取修為 x1.5', effect: { exp_mult: 1.5 }, type: 'buff' },
        '天道酬勤': { desc: '雖然資質平庸，但極度刻苦，獲取修為 x1.3', effect: { exp_mult: 1.3 }, type: 'buff' },
        '天生神力': { desc: '肌肉能解決一切修仙問題！物理戰鬥傷害 x1.5', effect: { combat_mult: 1.5 }, type: 'buff' },
        '聚靈體質': { desc: '行走的聚靈陣，若駐守宗門陣眼，靈氣產出暴增', effect: { core_aura_mult: 2.0 }, type: 'buff' },
        '好吃懶做': { desc: '產能減半，且有 30% 機率在工作時偷睡覺', effect: { prod_mult: 0.5, lazy_chance: 0.3 }, type: 'debuff' },
        '病秧子': { desc: '走兩步就喘，體力消耗極快，獲取修為 x0.8', effect: { exp_mult: 0.8 }, type: 'debuff' },
        '烏鴉嘴': { desc: '去哪哪倒楣，工作時引發意外的機率大幅提升', effect: { explode_chance: 0.3 }, type: 'debuff' },
        '龍王贅婿': { desc: '隱忍不發，50%機率罷工，但一旦認真修為獲取 x3.0！', effect: { lazy_chance: 0.5, exp_mult: 3.0 }, type: 'magic' },
        '氣運之子': { desc: '真正的天命之人。未來秘境奇遇獲得極品機率大增', effect: { luck_mult: 3.0 }, type: 'magic' },
        '老爺爺附體': { desc: '戒指裡藏著殘魂，即使閒置不工作，修為也會自動微幅增長', effect: { auto_exp: true }, type: 'magic' }
    },
