/**
 * V3.0 data_sect.js (萬象森羅 - 中西合璧擴張版 - 語法修復版)
...
export const DATA_SECT = {
    ...
    NAME_POOL: {
        ...
        SURNAMES: [
            ...
            // 霸氣複姓
            "東方", "西門", "南宮", "北冥", "軒轅", "上官", "歐陽", "皇甫", "令狐", "諸葛", "司徒", "司空", "百里", "公孫", "太史", "端木", "慕容", "宇文", "獨孤", "拓跋", "澹臺", "夏侯", "微生", // 🟢 修正：補上逗號
            // 西式奇幻家族
        ...
        GIVEN_NAMES: {
            ...
            // 仙氣與氣質
            spirit: ["凡", "塵", "仙", "靈", "虛", "無", "真", "道", "清", "靜", "逸", "然", "若", "夢", "幻", "音", "妙", "玄", "青", "紫", "玉", "明", "幽", "遠", "歌", "語", "心", "意", "緣"], // 🟢 修正：補上逗號
            // 西式奇幻 (翻譯感強)
    ...
    TRAITS: {
        ...
        '魔法少女(物理)': { desc: '法杖只是裝飾，拳頭才是真理。戰力+60%，悟性-20%', effect: { stat_atk_plus: 60, stat_int_minus: 20 }, type: 'funny' }, // 🟢 修正：補上逗號
