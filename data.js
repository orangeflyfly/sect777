...
const GAMEDATA = {
    ...
    PREFIXES: [
        ...
        { name: "斷岳的", attr: "str", value: 80 }, { name: "碎星 of", attr: "str", value: 100 },
    ...
    REGIONS: {
        "region_01": {
            ...
            maps: [
                { id: 101, name: "新手村後山", level: 1, minRealm: 0, monsterIds: ["m001", "m002"] },
                { id: 102, name: "青雲古道", level: 5, minRealm: 1, monsterIds: ["m002", "m003"] },
                { id: 103, name: "迷霧森林", level: 10, minRealm: 2, monsterIds: ["m003", "m004"] }
            ]
        },
        "region_02": {
            id: "region_02", name: "滄瀾州", bossId: "m010", nextRegion: "region_03",
            maps: [
                { id: 201, name: "滄瀾江畔", level: 15, minRealm: 3, monsterIds: ["m006", "m007"] },
                { id: 202, name: "沉船遺跡", level: 20, minRealm: 4, monsterIds: ["m007", "m008"] },
                { id: 203, name: "怒浪礁石", level: 25, minRealm: 5, monsterIds: ["m009"] }
            ]
        }
    },
    ...
    MONSTERS: {
        ...
        "m007": { id: "m007", name: "巨螯蟹", icon: "🦀", hp: 600, atk: 70, exp: 220, gold: 130 },
        "m008": { id: "m008", name: "溺水幽魂", icon: "👻", hp: 900, atk: 95, exp: 350, gold: 180 },
        "m009": { id: "m009", name: "深海巨鯊", icon: "🦈", hp: 1300, atk: 140, exp: 550, gold: 300 },
        "m010": { id: "m010", name: "滄瀾蛟龍", icon: "🐲", hp: 5000, atk: 380, exp: 2000, gold: 1000, isBoss: true }
    },
...
console.log("✅ [V1.7.0] data.js 數據層全量校準完成。");
